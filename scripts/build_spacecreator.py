...
def build_spacecreator(project_dir: str, build_dir: str, build_type: str, env_qt_distribution_dir: str) -> None:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--build_type', dest='build_type', type=str,
                        help='Release or Debug')
    parser.add_argument('--env_qt_distribution_dir', dest='env_qt_distribution_dir', type=str,
    ...
    build_spacecreator(project_dir, build_dir, build_type, env_qt_distribution_dir)

# python3 ./scripts/build_spacecreator.py --project_dir=/home/fisker/projects/spacecreator --build_dir=./build --build_type=Release --env_qt_distribution_dir=/home/fisker/opt/qtcreatorenv/Qt/6.3.1/gcc_64