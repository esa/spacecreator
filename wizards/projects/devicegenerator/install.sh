...
DISTFILES=$(qmake %{ProjectNameLowerCase}.pro -o /tmp/null 2>&1)
...
sed -i "s/put(sender_pid,/put((asn1SccPID)0,/g" $CD_INSTALLATION_DIRECTORY/%{ProjectNameLowerCase}/driver_transport.c*
