...
void tst_Asn1File::testChoiceType()
{
    ...
    QCOMPARE(toAsn1Type(choiceItem[ASN1_TYPE]), SEQUENCE);
    ...
    QCOMPARE(toAsn1Type(child[ASN1_TYPE]), DOUBLE);
    ...
    QCOMPARE(toAsn1Type(child[ASN1_TYPE]), STRING);
