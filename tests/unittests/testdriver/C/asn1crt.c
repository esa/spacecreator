...
#if WORD_SIZE == 8
const asn1SccUint64 ber_aux[] = { 0xFF, 0xFF00, 0xFF0000, 0xFF000000, 0xFF00000000ULL, 0xFF0000000000ULL,
...
{
    int i;
    if ((pVal1 != NULL) && (pVal2 != NULL) && pVal1->nCount == pVal2->nCount
            && pVal1->nCount <= OBJECT_IDENTIFIER_MAX_LENGTH) {
        flag ret = true;
