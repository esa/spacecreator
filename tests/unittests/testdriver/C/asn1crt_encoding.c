...
static asn1SccUint32 masks2[] = { 0x0, 0xFF, 0xFF00, 0xFF0000, 0xFF000000 };
...
{
    return (nBitsLength1 == nBitsLength2) && (nBitsLength1 / 8 == 0 || memcmp(arr1, arr2, nBitsLength1 / 8) == 0)
            && (nBitsLength1 % 8 > 0 ? (arr1[nBitsLength1 / 8] >> (8 - nBitsLength1 % 8)
                                               == arr2[nBitsLength1 / 8] >> (8 - nBitsLength1 % 8))
                                     : TRUE);
}
...
flag BitStream_DecodeNonNegativeInteger(BitStream *pBitStrm, asn1SccUint *v, int nBits)
{
    ...
    ret = BitStream_DecodeNonNegativeInteger32Neg(pBitStrm, &hi, 32)
            && BitStream_DecodeNonNegativeInteger32Neg(pBitStrm, &lo, nBits - 32);
...
void BitStream_EncodeReal(BitStream *pBitStrm, asn1Real v)
{
    ...
    if (exponent >= 0) {
        ...
        BitStream_AppendNBitOne(
                pBitStrm, nExpLen * 8 - GetNumberOfBitsForNonNegativeInteger((asn1SccUint)(-exponent - 1)));
...
int BitStream_checkBitPatternPresent(
        BitStream *pBitStrm, const byte bit_terminated_pattern[], size_t bit_terminated_pattern_size_in_bits)
{
    ...
    if (pBitStrm->currentByte * 8 + pBitStrm->currentBit + (long)bit_terminated_pattern_size_in_bits
            > pBitStrm->count * 8)
        return 0;
...
flag BitStream_ReadBits_nullterminated(BitStream *pBitStrm, const byte bit_terminated_pattern[],
        size_t bit_terminated_pattern_size_in_bits, byte *BuffToWrite, int nMaxReadBits, int *bitsRead)
{
    ...
    *bitsRead = 0;
    ...
    while (ret && (*bitsRead < nMaxReadBits)
            && ((checkBitPatternPresentResult = BitStream_checkBitPatternPresent(
                         pBitStrm, bit_terminated_pattern, bit_terminated_pattern_size_in_bits))
                       == 1)) {
    ...
    if (ret && (*bitsRead == nMaxReadBits) && (checkBitPatternPresentResult == 1)) {
        checkBitPatternPresentResult =
                BitStream_checkBitPatternPresent(pBitStrm, bit_terminated_pattern, bit_terminated_pattern_size_in_bits);
    }
...
flag BitStream_EncodeOctetString(
        BitStream *pBitStrm, const byte *arr, int nCount, asn1SccSint asn1SizeMin, asn1SccSint asn1SizeMax)
{
...
flag BitStream_DecodeOctetString(
        BitStream *pBitStrm, byte *arr, int *nCount, asn1SccSint asn1SizeMin, asn1SccSint asn1SizeMax)
{
    flag ret = TRUE;
    if (asn1SizeMax < 65536) {
        asn1SccSint nCountL;
...
flag BitStream_EncodeBitString(
        BitStream *pBitStrm, const byte *arr, int nCount, asn1SccSint asn1SizeMin, asn1SccSint asn1SizeMax)
{
    if (asn1SizeMax < 65536) {
        if (asn1SizeMin != asn1SizeMax) {
...
flag BitStream_DecodeBitString(
        BitStream *pBitStrm, byte *arr, int *pCount, asn1SccSint asn1SizeMin, asn1SccSint asn1SizeMax)
{
    flag ret = TRUE;
    if (asn1SizeMax < 65536) {
        asn1SccSint nCount;
