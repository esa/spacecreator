...
flag asn1SccT_UInt32_ACN_Encode(
        const asn1SccT_UInt32 *pVal, BitStream *pBitStrm, int *pErrCode, flag bCheckConstraints);
...
flag asn1SccT_Boolean_ACN_Encode(
        const asn1SccT_Boolean *pVal, BitStream *pBitStrm, int *pErrCode, flag bCheckConstraints);
...
flag asn1SccT_Null_Record_Encode(
        const asn1SccT_Null_Record *pVal, BitStream *pBitStrm, int *pErrCode, flag bCheckConstraints);
...
flag asn1SccT_Null_Record_ACN_Encode(
        const asn1SccT_Null_Record *pVal, BitStream *pBitStrm, int *pErrCode, flag bCheckConstraints);
...
flag asn1SccMyInteger_ACN_Encode(
        const asn1SccMyInteger *pVal, BitStream *pBitStrm, int *pErrCode, flag bCheckConstraints);
...
flag asn1SccMyReal_Equal(const asn1SccMyReal *pVal1, const asn1SccMyReal *pVal2);

void asn1SccMyReal_Initialize(asn1SccMyReal *pVal);

#define ERR_MYREAL 36 /**/
flag asn1SccMyReal_IsConstraintValid(const asn1SccMyReal *pVal, int *pErrCode);

#define ERR_UPER_ENCODE_MYREAL 37 /**/
...
#define ERR_ACN_DECODE_MYBOOL 45 /**/
