...
static void Acn_Enc_Int_PositiveInteger_ConstSize_big_endian_B(BitStream *pBitStrm, asn1SccUint intVal, int size)
{
    int i = 0;
...
static void Acn_Enc_Int_PositiveInteger_ConstSize_little_endian_N(BitStream *pBitStrm, asn1SccUint intVal, int size)
{
    int i = 0;
    asn1SccUint tmp = intVal;
...
static flag Acn_Dec_Int_PositiveInteger_ConstSize_little_endian_N(
        BitStream *pBitStrm, asn1SccUint *pIntVal, int SizeInBytes)
{
    int i;
    asn1SccUint ret = 0;
...
void Acn_Enc_Int_TwosComplement_ConstSize(BitStream *pBitStrm, asn1SccSint intVal, int encodedSizeInBits)
{
    if (intVal >= 0) {
        BitStream_AppendNBitZero(
                pBitStrm, encodedSizeInBits - GetNumberOfBitsForNonNegativeInteger((asn1SccUint)intVal));
        BitStream_EncodeNonNegativeInteger(pBitStrm, (asn1SccUint)intVal);
    } else {
        BitStream_AppendNBitOne(
                pBitStrm, encodedSizeInBits - GetNumberOfBitsForNonNegativeInteger((asn1SccUint)(-intVal - 1)));
...
void Acn_Enc_UInt_ASCII_VarSize_NullTerminated(
        BitStream *pBitStrm, asn1SccUint intVal, const byte null_characters[], size_t null_characters_size)
{
    byte digitsArray100[100];
    byte nChars;
    size_t i = 0;
...
void Acn_Enc_SInt_ASCII_VarSize_NullTerminated(
        BitStream *pBitStrm, asn1SccSint intVal, const byte null_characters[], size_t null_characters_size)
{
...
/*
flag Acn_Dec_String_Ascii_Null_Teminated_mult(BitStream* pBitStrm, asn1SccSint max, const byte null_character[], size_t
null_character_size,   char* strVal)
{
byte tmp[10];
...
flag Acn_Dec_UInt_ASCII_VarSize_NullTerminated(
        BitStream *pBitStrm, asn1SccUint *pIntVal, const byte null_characters[], size_t null_characters_size)
{
    byte digit;
    asn1SccUint ret = 0;
    byte tmp[10];
...
flag Acn_Dec_SInt_ASCII_VarSize_NullTerminated(
        BitStream *pBitStrm, asn1SccSint *pIntVal, const byte null_characters[], size_t null_characters_size)
{
    byte digit;
    asn1SccUint ret = 0;
...
void Acn_Enc_Real_IEEE754_32_big_endian(BitStream *pBitStrm, asn1Real realValue) { Acn_enc_real_big_endian(float) }
...
void Acn_Enc_Real_IEEE754_64_big_endian(BitStream *pBitStrm, asn1Real realValue) { Acn_enc_real_big_endian(double) }
...
void Acn_Enc_Real_IEEE754_32_little_endian(
        BitStream *pBitStrm, asn1Real realValue) { Acn_enc_real_little_endian(float) }
...
void Acn_Enc_Real_IEEE754_64_little_endian(
        BitStream *pBitStrm, asn1Real realValue) { Acn_enc_real_little_endian(double) }
...
static asn1SccSint Acn_Enc_String_Ascii_private(BitStream *pBitStrm, asn1SccSint max, const char *strVal)
{
    asn1SccSint i = 0;
...
void Acn_Enc_String_Ascii_Null_Teminated_mult(BitStream *pBitStrm, asn1SccSint max, const byte null_character[],
        size_t null_character_size, const char *strVal)
{
    size_t i = 0;
    Acn_Enc_String_Ascii_private(pBitStrm, max, strVal);
...
void Acn_Enc_String_Ascii_Internal_Field_Determinant(
        BitStream *pBitStrm, asn1SccSint max, asn1SccSint min, const char *strVal)
{
...
void Acn_Enc_String_CharIndex_FixSize(
        BitStream *pBitStrm, asn1SccSint max, byte allowedCharSet[], int charSetSize, const char *strVal)
{
    asn1SccSint i = 0;
    while (i < max) {
...
static asn1SccSint Acn_Enc_String_CharIndex_private(
        BitStream *pBitStrm, asn1SccSint max, byte allowedCharSet[], int charSetSize, const char *strVal)
{
    asn1SccSint i = 0;
    while ((strVal[i] != '\0') && (i < max)) {
...
void Acn_Enc_String_CharIndex_External_Field_Determinant(
        BitStream *pBitStrm, asn1SccSint max, byte allowedCharSet[], int charSetSize, const char *strVal)
{
    Acn_Enc_String_CharIndex_private(pBitStrm, max, allowedCharSet, charSetSize, strVal);
}

void Acn_Enc_String_CharIndex_Internal_Field_Determinant(BitStream *pBitStrm, asn1SccSint max, byte allowedCharSet[],
        int charSetSize, asn1SccSint min, const char *strVal)
{
    int strLen = strlen(strVal);
    BitStream_EncodeConstraintWholeNumber(pBitStrm, strLen <= max ? strLen : max, min, max);
    Acn_Enc_String_CharIndex_private(pBitStrm, max, allowedCharSet, charSetSize, strVal);
...
{
    static byte allowedCharSet[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
...
void Acn_Enc_IA5String_CharIndex_Internal_Field_Determinant(
        BitStream *pBitStrm, asn1SccSint max, asn1SccSint min, const char *strVal)
{
    static byte allowedCharSet[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
        0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F,
...
static flag Acn_Dec_String_Ascii_private(
        BitStream *pBitStrm, asn1SccSint max, asn1SccSint charactersToDecode, char *strVal)
{
    asn1SccSint i = 0;
...
/*
int put_byte_in_last_dec_bytes(byte last_dec_bytes[], size_t* pCur_size, size_t null_characters_size, byte
decodedCharacter, byte *pDiscardedCharacter) { int i; if (*pCur_size < null_characters_size) {
...
flag Acn_Dec_String_Ascii_Null_Teminated(BitStream* pBitStrm, asn1SccSint max, const byte null_characters[], size_t
null_characters_size, char* strVal)
{
asn1SccSint i = 0;
byte decodedCharacter;
...
if (!BitStream_ReadByte(pBitStrm, &decodedCharacter))
return FALSE;
ret = put_byte_in_last_dec_bytes(last_dec_bytes, &cur_size_of_last_dec_bytes, null_characters_size, decodedCharacter,
&characterToAppendInString);
...
flag Acn_Dec_String_Ascii_Null_Teminated_mult(
        BitStream *pBitStrm, asn1SccSint max, const byte null_character[], size_t null_character_size, char *strVal)
{
    byte tmp[10];
    size_t sz = null_character_size < 10 ? null_character_size : 10;
    memset(tmp, 0x0, 10);
...
flag Acn_Dec_String_Ascii_External_Field_Determinant(
        BitStream *pBitStrm, asn1SccSint max, asn1SccSint extSizeDeterminatFld, char *strVal)
{
    return Acn_Dec_String_Ascii_private(
            pBitStrm, max, extSizeDeterminatFld <= max ? extSizeDeterminatFld : max, strVal);
}

flag Acn_Dec_String_Ascii_Internal_Field_Determinant(
        BitStream *pBitStrm, asn1SccSint max, asn1SccSint min, char *strVal)
{
    asn1SccSint nCount;
...
static flag Acn_Dec_String_CharIndex_private(BitStream *pBitStrm, asn1SccSint max, asn1SccSint charactersToDecode,
        byte allowedCharSet[], int charSetSize, char *strVal)
{
    asn1SccSint i = 0;
    memset(strVal, 0x0, (size_t)max + 1);
    while (i < charactersToDecode) {
...
flag Acn_Dec_String_CharIndex_FixSize(
        BitStream *pBitStrm, asn1SccSint max, byte allowedCharSet[], int charSetSize, char *strVal)
{
    return Acn_Dec_String_CharIndex_private(pBitStrm, max, max, allowedCharSet, charSetSize, strVal);
}

flag Acn_Dec_String_CharIndex_External_Field_Determinant(BitStream *pBitStrm, asn1SccSint max, byte allowedCharSet[],
        int charSetSize, asn1SccSint extSizeDeterminatFld, char *strVal)
{
    return Acn_Dec_String_CharIndex_private(pBitStrm, max, extSizeDeterminatFld <= max ? extSizeDeterminatFld : max,
            allowedCharSet, charSetSize, strVal);
}

flag Acn_Dec_String_CharIndex_Internal_Field_Determinant(
        BitStream *pBitStrm, asn1SccSint max, byte allowedCharSet[], int charSetSize, asn1SccSint min, char *strVal)
{
    asn1SccSint nCount;
    if (!BitStream_DecodeConstraintWholeNumber(pBitStrm, &nCount, min, max))
        return FALSE;
    return Acn_Dec_String_CharIndex_private(
            pBitStrm, max, nCount <= max ? nCount : max, allowedCharSet, charSetSize, strVal);
}

flag Acn_Dec_IA5String_CharIndex_External_Field_Determinant(
        BitStream *pBitStrm, asn1SccSint max, asn1SccSint extSizeDeterminatFld, char *strVal)
{
    static byte allowedCharSet[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
        0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F,
        ...
        0x7A, 0x7B, 0x7C, 0x7D, 0x7E, 0x7F };
    return Acn_Dec_String_CharIndex_private(
            pBitStrm, max, extSizeDeterminatFld <= max ? extSizeDeterminatFld : max, allowedCharSet, 128, strVal);
}

flag Acn_Dec_IA5String_CharIndex_Internal_Field_Determinant(
        BitStream *pBitStrm, asn1SccSint max, asn1SccSint min, char *strVal)
{
    asn1SccSint nCount;
    static byte allowedCharSet[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D,
