...
void tst_IntegerSubset::testSimpleSumTwoNumbersB()
{
    ...
    QCOMPARE(result.getRanges().front(), std::make_pair(1, 1));
...
void tst_IntegerSubset::testSumRangeAndNumberSeparatedLeft()
{
    ...
    QCOMPARE(result.getRanges().size(), 2);
    QCOMPARE(result.getRanges().front(), std::make_pair(1, 1));
    QCOMPARE(result.getRanges().back(), std::make_pair(3, 10));
}
...
void tst_IntegerSubset::testSumRangeAndNumberSeparatedRight()
{
    ...
    QCOMPARE(result.getRanges().size(), 2);
    QCOMPARE(result.getRanges().front(), std::make_pair(3, 5));
    QCOMPARE(result.getRanges().back(), std::make_pair(7, 7));
}
...
void tst_IntegerSubset::testSumRangeAndNumberIncludedMiddle()
{
    ...
    QVERIFY(!result.isSingleValue());
    QCOMPARE(result.getRanges().size(), 1);
    QCOMPARE(result.getRanges().front(), std::make_pair(1, 10));
}
...
void tst_IntegerSubset::testSumTwoRangesSeparated()
{
    ...
    QVERIFY(!result.isSingleValue());
    QCOMPARE(result.getRanges().size(), 2);
    QCOMPARE(result.getRanges().front(), std::make_pair(1, 3));
    QCOMPARE(result.getRanges().back(), std::make_pair(7, 10));
}
...
void tst_IntegerSubset::testIntersectSameNumber()
{
    ...
    QVERIFY(result.isSingleValue());
    QCOMPARE(result.getRanges().size(), 1);
    QCOMPARE(result.getRanges().front(), std::make_pair(2, 2));
}
...
void tst_IntegerSubset::testIntersectRangeNumberRight()
{
    ...
    QVERIFY(result.isSingleValue());
    QCOMPARE(result.getRanges().size(), 1);
    QCOMPARE(result.getRanges().front(), std::make_pair(10, 10));
}
...
void tst_IntegerSubset::testIntersectRangesEdge()
{
    ...
    QVERIFY(result.isSingleValue());
    QCOMPARE(result.getRanges().size(), 1);
    QCOMPARE(result.getRanges().front(), std::make_pair(5, 5));
}
...
void tst_IntegerSubset::testIntersectRangesIncludedMiddle()
{
    ...
    QVERIFY(!result.isSingleValue());
    QCOMPARE(result.getRanges().size(), 1);
    QCOMPARE(result.getRanges().front(), std::make_pair(2, 5));
}
...
void tst_IntegerSubset::testIntersectThreeRanges()
{
    ...
    QVERIFY(!result.isSingleValue());
    QCOMPARE(result.getRanges().size(), 2);
    QCOMPARE(result.getRanges().front(), std::make_pair(2, 3));
    QCOMPARE(result.getRanges().back(), std::make_pair(7, 8));
}
