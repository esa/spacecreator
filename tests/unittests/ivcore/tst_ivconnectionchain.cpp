...
class tst_IVConnectionChain : public QObject
{
    Q_OBJECT
...
bool tst_IVConnectionChain::checkChain(ivm::IVConnectionChain *chain, const QStringList &functionNames) const
{
    if (chain == nullptr) {
        return false;
    }
...
void tst_IVConnectionChain::test3StraightConnections()
{
...
void tst_IVConnectionChain::testTargetSplitsIntoTwo()
{
    ivm::IVModel model(conf);
    ivm::IVXMLReader parser;
...
void tst_IVConnectionChain::testTargetJoinIntone()
{
...
void tst_IVConnectionChain::testChainCreationMultiChainOnInterfaces()
{
    ivm::IVModel model(conf);
    ivm::IVXMLReader parser;
...
// MiniA -> BlockA -> BlockB -> MiniB
void tst_IVConnectionChain::testContains()
{
...
// MiniA -> BlockA -> BlockB -> MiniB
void tst_IVConnectionChain::testGetNames()
{
...
QTEST_APPLESS_MAIN(tst_IVConnectionChain)

#include "tst_ivconnectionchain.moc"
