...
void tst_IVNameValidator::test_functionName_data()
{
...
void tst_IVNameValidator::test_functionName()
{
    QFETCH(QString, name);
...
QTEST_APPLESS_MAIN(tst_IVNameValidator)

#include "tst_ivnamevalidator.moc"
