...
private slots:
    void testIfaceSegment_data()
    {
        ...
        QTest::newRow("NormalScenario") << rect100 << QPointF(10, 10) << QPointF(90, 90) << QLineF(10, 10, 26, 10);

        QTest::newRow("NullVector") << rect100 << QPointF(50, 50) << QPointF(50, 50) << QLineF(50, 50, 66, 50);

        QTest::newRow("LastEndPointOutside")
                << rect100 << QPointF(10, 10) << QPointF(110, 110) << QLineF(10, 10, -6, 10);
    }
