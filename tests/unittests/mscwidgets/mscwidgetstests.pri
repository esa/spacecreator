# Add mscwidgets
win32:CONFIG(release, debug|release): LIBS += -L$$clean_path($$OUT_PWD/../../../../libs/mscwidgets/release/) -lmscwidgets
else:win32:CONFIG(debug, debug|release): LIBS += -L$$clean_path($$OUT_PWD/../../../../libs/mscwidgets/debug/) -lmscwidgets
else:unix: LIBS += -L$$clean_path($$OUT_PWD/../../../../libs/mscwidgets/) -lmscwidgets
