...
void AstXmlParserTests::test_importedType()
{
    ...
    const auto &importedTypes = m_parsedData["X.asn"]->definitions("Defs")->importedTypes();

    QCOMPARE(importedTypes.size(), std::size_t(1));
    QVERIFY(importedTypes.find(ImportedType("OtherDefinitions", "Imported")) != importedTypes.end());
}
...
void AstXmlParserTests::test_multipleImportedType()
{
    ...
    QCOMPARE(importedTypes.size(), std::size_t(2));
    QVERIFY(importedTypes.find(ImportedType("OtherDefinitions", "Imported1")) != importedTypes.end());
    QVERIFY(importedTypes.find(ImportedType("OtherDefinitions", "Imported2")) != importedTypes.end());
}
...
void AstXmlParserTests::test_enumeratedValueAssignment()
{
    ...
    const auto myEnum = m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->value("myEnum");
...
void AstXmlParserTests::test_singleRealValueAssignment()
{
    ...
    const auto myReal = m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->value("myReal");
...
void AstXmlParserTests::test_sequenceOfAssignmentWithRangeConstraintInsideSizeConstraint()
{
    ...
    const auto &sequenceOfType = dynamic_cast<const Types::SequenceOf *>(type->type());
    QVERIFY(sequenceOfType);
    QCOMPARE(toString(sequenceOfType->constraints()), QStringLiteral("(SIZE((0 .. 10 | 20 .. 22)))"));
}
...
void AstXmlParserTests::test_sequenceOfValueAssignment()
{
    ...
    const auto mySeqOf = m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->value("mySequenceOfValue");
...
{
    auto item = find_if(
            col.begin(), col.end(), [id](const typename Collection::value_type &item) { return item->id() == id; });
...
void AstXmlParserTests::test_sequnceWithAcnParams()
{
    ...
    param = itemFromCollection(internalSeqTypeParam, QStringLiteral("MyModel.ParamSeq.internal.type"));
    QVERIFY(param != nullptr);
    QCOMPARE(param->id(), QStringLiteral("MyModel.ParamSeq.internal.type"));
    QCOMPARE(param->name(), QStringLiteral("type"));
    QCOMPARE(param->type(), QStringLiteral("INTEGER"));

    param = itemFromCollection(internalSeqTypeParam, QStringLiteral("MyModel.ParamSeq.internal.other"));
    QVERIFY(param != nullptr);
...
void AstXmlParserTests::test_octetStringWithRangedSizeConstraint()
{
    ...
    const auto *ocetStringType = dynamic_cast<const Types::OctetString *>(type->type());
    QVERIFY(ocetStringType);
    QCOMPARE(toString(ocetStringType->constraints()), QStringLiteral("(SIZE(((1 .. 2 | 4 .. 5) | 7 .. 8)))"));
}
...
void AstXmlParserTests::test_octetStringValueAssignment()
{
    ...
    auto octetStringType = m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->value("myOctet");
...
void AstXmlParserTests::test_iA5StringWithSizeConstraint()
{
    ...
    const auto type = m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->type("MyIA5String");
...
void AstXmlParserTests::test_iA5StringWithValueConstraint()
{
    ...
    QCOMPARE(toString(myIA5String->constraints()),
            QStringLiteral("((SIZE(1 .. 10) ^ FROM(((\"A\" .. \"D\" | \"X\" .. \"Z\") | \"1\" .. \"9\"))))"));
}
...
void AstXmlParserTests::test_numericStringWithSizeConstraint()
{
    ...
    const auto type = m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->type("MyNumericString");
...
void AstXmlParserTests::test_numericStringWithValueConstraint()
{
    ...
    QCOMPARE(toString(numericString->constraints()),
            QStringLiteral("((SIZE(10) ^ FROM((\"1\" .. \"5\" | (\"6\" .. \"9\" ^ \"1\" .. \"8\")))))"));
}
...
void AstXmlParserTests::test_bitStringWithSizeConstraint()
{
    ...
    const auto type = m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->type("MyBitString");
...
void AstXmlParserTests::test_bitStringWithRangedSizeConstraint()
{
    ...
    const auto type = m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->type("MyBitString");
    const auto bitString = dynamic_cast<const Types::BitString *>(type->type());
    QCOMPARE(toString(bitString->constraints()), QStringLiteral("(SIZE(((10 .. 20 | 40 .. 50) | 70 .. 80)))"));
}
...
void AstXmlParserTests::test_nestedValueAssignments()
{
    ...
    const auto myNestedSeq =
            m_parsedData["Test2File.asn"]->definitions("TestDefinitions")->value("nestedSequenceOfInstance");
    ...
    QCOMPARE(mySeqInstance->value()->asString(), QStringLiteral("{ms {1, 2, 3, 4}, is 5, os {5.5, 6.6}}"));
}
...
void AstXmlParserTests::test_parametrizedInstances()
{
    ...
    auto type = m_parsedData["TestFile.asn"]->definitions("TestDefinitions")->type("MyParametrizedSequenceInstance");
