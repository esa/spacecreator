...
ERR_PID_RANGE:constant Integer := 96; -- (0..4)
...
type asn1SccPID is (asn1Sccactuator, asn1Sccegse, asn1Sccmodemanager, asn1Sccsensor, asn1Sccenv) with Size => adaasn1rtl.Enumerated_Size;
for asn1SccPID use
    (asn1Sccactuator => 0, asn1Sccegse => 1, asn1Sccmodemanager => 2, asn1Sccsensor => 3, asn1Sccenv => 4);

function asn1SccPID_Equal(val1, val2 : asn1SccPID) return Boolean;

ERR_PID:constant Integer := 101; -- actuator | egse | modemanager | sensor | env
