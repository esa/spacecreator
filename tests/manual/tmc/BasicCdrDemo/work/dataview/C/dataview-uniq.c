...
{
    flag ret = TRUE;
    ret = asn1SccT_Integer_IsConstraintValid((&(pVal->param_a)), pErrCode);
    if (ret) {
        ret = asn1SccT_Integer_IsConstraintValid((&(pVal->param_b)), pErrCode);
    }   /*COVERAGE_IGNORE*/
...
void asn1SccT_Config_Initialize(asn1SccT_Config* pVal)
{
	...
	/*set param_a */
	asn1SccT_Integer_Initialize((&(pVal->param_a)));
	/*set param_b */
	asn1SccT_Integer_Initialize((&(pVal->param_b)));
}
...
flag asn1SccT_Config_Encode(const asn1SccT_Config* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccT_Config_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    /*Encode param_a */
	    ret = asn1SccT_Integer_Encode((&(pVal->param_a)), pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode param_b */
	        ret = asn1SccT_Integer_Encode((&(pVal->param_b)), pBitStrm, pErrCode, FALSE);
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccT_Config_Decode(asn1SccT_Config* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode param_a */
	ret = asn1SccT_Integer_Decode((&(pVal->param_a)), pBitStrm, pErrCode);
	if (ret) {
	    /*Decode param_b */
	    ret = asn1SccT_Integer_Decode((&(pVal->param_b)), pBitStrm, pErrCode);
	}   /*COVERAGE_IGNORE*/

	return ret  && asn1SccT_Config_IsConstraintValid(pVal, pErrCode);
}
...
flag asn1SccT_Config_ACN_Encode(const asn1SccT_Config* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    ...
    *pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    /*Encode param_a */
	    ret = asn1SccT_Integer_ACN_Encode((&(pVal->param_a)), pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode param_b */
	        ret = asn1SccT_Integer_ACN_Encode((&(pVal->param_b)), pBitStrm, pErrCode, FALSE);
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccT_Config_ACN_Decode(asn1SccT_Config* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode param_a */
	ret = asn1SccT_Integer_ACN_Decode((&(pVal->param_a)), pBitStrm, pErrCode);
	if (ret) {
	    /*Decode param_b */
	    ret = asn1SccT_Integer_ACN_Decode((&(pVal->param_b)), pBitStrm, pErrCode);
	}   /*COVERAGE_IGNORE*/
...
{
    flag ret = TRUE;
    ret = asn1SccT_Integer_IsConstraintValid((&(pVal->reading)), pErrCode);
    if (ret) {
        ret = asn1SccT_Integer_IsConstraintValid((&(pVal->ctrl)), pErrCode);
        if (ret) {
            ret = asn1SccT_Integer_IsConstraintValid((&(pVal->feedback)), pErrCode);
        }   /*COVERAGE_IGNORE*/
    }   /*COVERAGE_IGNORE*/
...
void asn1SccT_Report_Initialize(asn1SccT_Report* pVal)
{
	...
	/*set reading */
	asn1SccT_Integer_Initialize((&(pVal->reading)));
	/*set ctrl */
	asn1SccT_Integer_Initialize((&(pVal->ctrl)));
	/*set feedback */
	asn1SccT_Integer_Initialize((&(pVal->feedback)));
}
...
flag asn1SccT_Report_Encode(const asn1SccT_Report* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccT_Report_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    /*Encode reading */
	    ret = asn1SccT_Integer_Encode((&(pVal->reading)), pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode ctrl */
	        ret = asn1SccT_Integer_Encode((&(pVal->ctrl)), pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode feedback */
	            ret = asn1SccT_Integer_Encode((&(pVal->feedback)), pBitStrm, pErrCode, FALSE);
	        }   /*COVERAGE_IGNORE*/
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccT_Report_Decode(asn1SccT_Report* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode reading */
	ret = asn1SccT_Integer_Decode((&(pVal->reading)), pBitStrm, pErrCode);
	if (ret) {
	    /*Decode ctrl */
	    ret = asn1SccT_Integer_Decode((&(pVal->ctrl)), pBitStrm, pErrCode);
	    if (ret) {
	        /*Decode feedback */
	        ret = asn1SccT_Integer_Decode((&(pVal->feedback)), pBitStrm, pErrCode);
	    }   /*COVERAGE_IGNORE*/
	}   /*COVERAGE_IGNORE*/

	return ret  && asn1SccT_Report_IsConstraintValid(pVal, pErrCode);
}
...
flag asn1SccT_Report_ACN_Encode(const asn1SccT_Report* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    ...
    *pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    /*Encode reading */
	    ret = asn1SccT_Integer_ACN_Encode((&(pVal->reading)), pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode ctrl */
	        ret = asn1SccT_Integer_ACN_Encode((&(pVal->ctrl)), pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode feedback */
	            ret = asn1SccT_Integer_ACN_Encode((&(pVal->feedback)), pBitStrm, pErrCode, FALSE);
	        }   /*COVERAGE_IGNORE*/
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccT_Report_ACN_Decode(asn1SccT_Report* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode reading */
	ret = asn1SccT_Integer_ACN_Decode((&(pVal->reading)), pBitStrm, pErrCode);
	if (ret) {
	    /*Decode ctrl */
	    ret = asn1SccT_Integer_ACN_Decode((&(pVal->ctrl)), pBitStrm, pErrCode);
	    if (ret) {
	        /*Decode feedback */
	        ret = asn1SccT_Integer_ACN_Decode((&(pVal->feedback)), pBitStrm, pErrCode);
	    }   /*COVERAGE_IGNORE*/
	}   /*COVERAGE_IGNORE*/
