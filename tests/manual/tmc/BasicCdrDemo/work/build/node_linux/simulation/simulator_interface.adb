...
package body Simulator_Interface is
   ...
   begin
      ...
      loop
         ...
         exit when Stop_Condition or (Simulator.Events.Length = 0 and User_State.Actuator_Queue.Length = 0 and User_State.Modemanager_Queue.Length = 0);
   ...
   begin
      ...
      Sensor_Events.Exhaust_Interfaces (User_State, Callback => ES_Callback'Access);
...
--              when Actuator, Egse, Modemanager, Sensor_PRESENT =>
--                 Actuator, Egse, Modemanager, Sensor_Events.Print_Event (Event => Event.Input_Event.Event.Actuator, Egse, Modemanager, Sensor);
--              @@END_TABLE@@
--           end case;
--        when Output_Event_PRESENT =>
--           case Event.Output_Event.Event.Kind is
--              @@TABLE'ALIGN_ON("=>", "(", "Global")@@
--              when Actuator, Egse, Modemanager, Sensor_PRESENT =>
--                 Actuator, Egse, Modemanager, Sensor_Events.Print_Event (Event => Event.Output_Event.Event.Actuator, Egse, Modemanager, Sensor);
--              @@END_TABLE@@
--           end case;
--     end case;
   end Print_Event;
