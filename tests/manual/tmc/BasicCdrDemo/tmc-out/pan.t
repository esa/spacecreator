...
/*->*/	trans[7][4]	= settr(474,34,62,6,6,"D_STEP12361", 1, 2, 0);
	T = trans[ 7][62] = settr(532,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(532,0,9,0,0,"sub-sequence", 1, 8, 9);
	T = trans[ 7][9] = settr(479,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(479,0,6,0,0,"sub-sequence", 1, 8, 9);
	trans[7][6]	= settr(476,2,8,7,7,"global_state.modemanager.sender = 4", 1, 8, 9);
	T = trans[ 7][8] = settr(478,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(478,0,7,0,0,"sub-sequence", 1, 8, 9);
	trans[7][7]	= settr(477,2,61,8,0,"assert((((((global_state.modemanager.sender==0)||(global_state.modemanager.sender==1))||(global_state.modemanager.sender==2))||(global_state.modemanager.sender==3))||(global_state.modemanager.sender==4)))", 1, 8, 9);
	T = trans[ 7][61] = settr(531,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(531,0,10,0,0,"sub-sequence", 1, 8, 9);
	trans[7][10]	= settr(480,2,58,9,9,"transition_id = 0", 1, 8, 9); /* m: 11 -> 0,58 */
	reached7[11] = 1;
	trans[7][11]	= settr(0,0,0,0,0,"transition_id = 0",0,0,0);
	trans[7][59]	= settr(529,2,58,1,0,".(goto)", 1, 8, 9);
	T = trans[7][58] = settr(528,2,0,0,0,"DO", 1, 8, 9);
	    T->nxt	= settr(528,2,55,0,0,"DO", 1, 8, 9);
	T = trans[7][55] = settr(525,2,0,0,0,"IF", 1, 8, 9);
	T = T->nxt	= settr(525,2,12,0,0,"IF", 1, 8, 9);
	T = T->nxt	= settr(525,2,14,0,0,"IF", 1, 8, 9);
	T = T->nxt	= settr(525,2,18,0,0,"IF", 1, 8, 9);
	T = T->nxt	= settr(525,2,38,0,0,"IF", 1, 8, 9);
	    T->nxt	= settr(525,2,49,0,0,"IF", 1, 8, 9);
	trans[7][12]	= settr(482,2,63,10,10,"((transition_id==-(1)))", 1, 8, 9);
	trans[7][13]	= settr(483,2,63,1,0,"goto :b21", 1, 8, 9);
	trans[7][56]	= settr(526,2,57,1,0,".(goto)", 1, 8, 9);
	trans[7][14]	= settr(484,2,57,11,11,"((transition_id==0))", 1, 8, 9); /* m: 15 -> 57,0 */
	reached7[15] = 1;
	trans[7][15]	= settr(0,0,0,0,0,"transition_id = -(1)",0,0,0);
	trans[7][16]	= settr(0,0,0,0,0,"global_state.modemanager.state = 1",0,0,0);
	trans[7][17]	= settr(487,2,57,1,0,"goto continuous_signals", 1, 8, 9);
	...
	T = trans[ 7][33] = settr(503,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(503,0,24,0,0,"sub-sequence", 1, 8, 9);
	T = trans[ 7][24] = settr(494,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(494,0,21,0,0,"sub-sequence", 1, 8, 9);
	trans[7][21]	= settr(491,2,23,13,13,"global_state.modemanager.rprt.reading = global_state.modemanager.xin", 1, 8, 9);
	T = trans[ 7][23] = settr(493,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(493,0,22,0,0,"sub-sequence", 1, 8, 9);
	trans[7][22]	= settr(492,2,28,14,0,"assert(((global_state.modemanager.rprt.reading>=0)&&(global_state.modemanager.rprt.reading<=1000000)))", 1, 8, 9);
	T = trans[ 7][28] = settr(498,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(498,0,25,0,0,"sub-sequence", 1, 8, 9);
	trans[7][25]	= settr(495,2,27,15,15,"global_state.modemanager.rprt.ctrl = global_state.modemanager.xout", 1, 8, 9);
	T = trans[ 7][27] = settr(497,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(497,0,26,0,0,"sub-sequence", 1, 8, 9);
	trans[7][26]	= settr(496,2,32,16,0,"assert(((global_state.modemanager.rprt.ctrl>=0)&&(global_state.modemanager.rprt.ctrl<=1000000)))", 1, 8, 9);
	T = trans[ 7][32] = settr(502,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(502,0,29,0,0,"sub-sequence", 1, 8, 9);
	trans[7][29]	= settr(499,2,31,17,17,"global_state.modemanager.rprt.feedback = global_state.modemanager.xfeedback", 1, 8, 9);
	T = trans[ 7][31] = settr(501,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(501,0,30,0,0,"sub-sequence", 1, 8, 9);
	trans[7][30]	= settr(500,2,35,18,0,"assert(((global_state.modemanager.rprt.feedback>=0)&&(global_state.modemanager.rprt.feedback<=1000000)))", 1, 8, 9);
	T = trans[ 7][35] = settr(505,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(505,0,34,0,0,"sub-sequence", 1, 8, 9);
	trans[7][34]	= settr(504,2,57,19,19,"Egse_tm_channel!global_state.modemanager.rprt.reading,global_state.modemanager.rprt.ctrl,global_state.modemanager.rprt.feedback", 1, 8, 9); /* m: 36 -> 57,0 */
	reached7[36] = 1;
	trans[7][36]	= settr(0,0,0,0,0,"transition_id = -(1)",0,0,0);
	trans[7][37]	= settr(507,2,57,1,0,"goto continuous_signals", 1, 8, 9);
	trans[7][38]	= settr(508,2,40,20,20,"((transition_id==2))", 1, 8, 9);
	T = trans[ 7][40] = settr(510,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(510,0,39,0,0,"sub-sequence", 1, 8, 9);
	trans[7][39]	= settr(509,2,44,1,0,"(1)", 1, 8, 9);
	T = trans[ 7][44] = settr(514,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(514,0,41,0,0,"sub-sequence", 1, 8, 9);
	trans[7][41]	= settr(511,2,43,21,21,"global_state.modemanager.xout = ((global_state.modemanager.xin*global_state.modemanager.cfg.param_a)+global_state.modemanager.cfg.param_b)", 1, 8, 9);
	T = trans[ 7][43] = settr(513,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(513,0,42,0,0,"sub-sequence", 1, 8, 9);
	trans[7][42]	= settr(512,2,46,22,0,"assert(((global_state.modemanager.xout>=0)&&(global_state.modemanager.xout<=1000000)))", 1, 8, 9);
	T = trans[ 7][46] = settr(516,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(516,0,45,0,0,"sub-sequence", 1, 8, 9);
	trans[7][45]	= settr(515,2,57,23,23,"Actuator_ctrl_channel!global_state.modemanager.xout", 1, 8, 9); /* m: 47 -> 57,0 */
	reached7[47] = 1;
	trans[7][47]	= settr(0,0,0,0,0,"transition_id = -(1)",0,0,0);
	trans[7][48]	= settr(518,2,57,1,0,"goto continuous_signals", 1, 8, 9);
	trans[7][49]	= settr(519,2,51,24,24,"((transition_id==3))", 1, 8, 9);
	T = trans[ 7][51] = settr(521,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(521,0,50,0,0,"sub-sequence", 1, 8, 9);
	trans[7][50]	= settr(520,2,57,25,25,"(1)", 1, 8, 9); /* m: 52 -> 57,0 */
	reached7[52] = 1;
	trans[7][52]	= settr(0,0,0,0,0,"transition_id = -(1)",0,0,0);
	trans[7][53]	= settr(0,0,0,0,0,"global_state.modemanager.state = 0",0,0,0);
	trans[7][54]	= settr(524,2,57,1,0,"goto continuous_signals", 1, 8, 9);
	trans[7][57]	= settr(527,2,58,1,0,"(1)", 1, 8, 9);
	trans[7][60]	= settr(530,2,63,1,0,"break", 1, 8, 9);
	trans[7][63]	= settr(533,2,100,26,26,"Modemanager_lock!1", 1, 8, 9);
	T = trans[ 7][100] = settr(570,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(570,0,67,0,0,"sub-sequence", 1, 8, 9);
	T = trans[ 7][67] = settr(537,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(537,0,64,0,0,"sub-sequence", 1, 8, 9);
	trans[7][64]	= settr(534,2,66,27,27,"global_state.actuator.sender = 4", 1, 8, 9);
	T = trans[ 7][66] = settr(536,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(536,0,65,0,0,"sub-sequence", 1, 8, 9);
	trans[7][65]	= settr(535,2,99,28,0,"assert((((((global_state.actuator.sender==0)||(global_state.actuator.sender==1))||(global_state.actuator.sender==2))||(global_state.actuator.sender==3))||(global_state.actuator.sender==4)))", 1, 8, 9);
	T = trans[ 7][99] = settr(569,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(569,0,68,0,0,"sub-sequence", 1, 8, 9);
	trans[7][68]	= settr(538,2,96,29,29,"transition_id = 0", 1, 8, 9); /* m: 69 -> 0,96 */
	reached7[69] = 1;
	...
	T = T->nxt	= settr(563,2,70,0,0,"IF", 1, 8, 9);
	T = T->nxt	= settr(563,2,72,0,0,"IF", 1, 8, 9);
	    T->nxt	= settr(563,2,76,0,0,"IF", 1, 8, 9);
	trans[7][70]	= settr(540,2,101,30,30,"((transition_id==-(1)))", 1, 8, 9);
	trans[7][71]	= settr(541,2,101,1,0,"goto :b22", 1, 8, 9);
	trans[7][94]	= settr(564,2,95,1,0,".(goto)", 1, 8, 9);
	trans[7][72]	= settr(542,2,95,31,31,"((transition_id==0))", 1, 8, 9); /* m: 73 -> 95,0 */
	reached7[73] = 1;
	...
	trans[7][76]	= settr(546,2,78,32,32,"((transition_id==1))", 1, 8, 9);
	T = trans[ 7][78] = settr(548,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(548,0,77,0,0,"sub-sequence", 1, 8, 9);
	trans[7][77]	= settr(547,2,91,1,0,"(1)", 1, 8, 9);
	T = trans[7][91] = settr(561,2,0,0,0,"IF", 1, 8, 9);
	T = T->nxt	= settr(561,2,79,0,0,"IF", 1, 8, 9);
	    T->nxt	= settr(561,2,85,0,0,"IF", 1, 8, 9);
	trans[7][79]	= settr(549,2,81,33,0,"(((global_state.actuator.x>10)==1))", 1, 8, 9);
	T = trans[ 7][81] = settr(551,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(551,0,80,0,0,"sub-sequence", 1, 8, 9);
	trans[7][80]	= settr(550,2,95,34,34,"Modemanager_feedback_channel!global_state.actuator.x", 1, 8, 9); /* m: 82 -> 95,0 */
	reached7[82] = 1;
	trans[7][82]	= settr(0,0,0,0,0,"transition_id = -(1)",0,0,0);
	trans[7][83]	= settr(0,0,0,0,0,"global_state.actuator.state = 1",0,0,0);
	trans[7][84]	= settr(554,2,95,1,0,"goto continuous_signals", 1, 8, 9);
	trans[7][92]	= settr(562,2,95,1,0,".(goto)", 1, 8, 9);
	trans[7][85]	= settr(555,2,87,35,0,"(((global_state.actuator.x>10)==0))", 1, 8, 9);
	T = trans[ 7][87] = settr(557,0,0,0,0,"sub-sequence", 1, 8, 9);
	T->nxt	= settr(557,0,86,0,0,"sub-sequence", 1, 8, 9);
	trans[7][86]	= settr(556,2,95,36,36,"Modemanager_feedback_channel!0", 1, 8, 9); /* m: 88 -> 95,0 */
	reached7[88] = 1;
	trans[7][88]	= settr(0,0,0,0,0,"transition_id = -(1)",0,0,0);
	trans[7][89]	= settr(0,0,0,0,0,"global_state.actuator.state = 0",0,0,0);
	trans[7][90]	= settr(560,2,95,1,0,"goto continuous_signals", 1, 8, 9);
	trans[7][95]	= settr(565,2,96,1,0,"(1)", 1, 8, 9);
	trans[7][98]	= settr(568,2,101,1,0,"break", 1, 8, 9);
	trans[7][101]	= settr(571,4,104,37,37,"Actuator_lock!1", 1, 8, 9); /* m: 102 -> 104,0 */
	reached7[102] = 1;
