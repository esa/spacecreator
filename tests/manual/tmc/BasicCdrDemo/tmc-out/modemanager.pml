inline Modemanager_0_transition(id)
{
  ...
  ::if
    ...
    ::(transition_id == 1)->
      ...
      {
        TInteger_assign_value(global_state.modemanager.rprt.reading, global_state.modemanager.xin);
        TInteger_assign_value(global_state.modemanager.rprt.ctrl, global_state.modemanager.xout);
        TInteger_assign_value(global_state.modemanager.rprt.feedback, global_state.modemanager.xfeedback);
      }
    ...
    ::(transition_id == 2)->
      Modemanager_0_get_sender(global_state.modemanager.sender);
      TInteger_assign_value(global_state.modemanager.xout, ((global_state.modemanager.xin * global_state.modemanager.cfg.param_a) + global_state.modemanager.cfg.param_b));
...
inline Modemanager_0_PI_0_feedback(input_param)
{
  if
  ::(global_state.modemanager.state == Modemanager_States_configured)->
    TInteger_assign_value(global_state.modemanager.xfeedback, input_param);
...
inline Modemanager_0_PI_0_reading(input_param)
{
  if
  ::(global_state.modemanager.state == Modemanager_States_configured)->
    TInteger_assign_value(global_state.modemanager.xin, input_param);
...
inline Modemanager_0_PI_0_tc(input_param)
{
  if
  ::(global_state.modemanager.state == Modemanager_States_uninitialized)->
    TConfig_assign_value(global_state.modemanager.cfg, input_param);
