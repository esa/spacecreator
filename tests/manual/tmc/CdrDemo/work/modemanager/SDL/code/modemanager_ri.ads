...
package Modemanager_RI is
   ...
   procedure Actuatortc1 (Tc : in out asn1SccActuatorcommand; Dest_PID : asn1sccPID := asn1sccEnv);
   
   
   procedure Actuatortc2 (Tc : in out asn1SccActuatorcommand; Dest_PID : asn1sccPID := asn1sccEnv);
   
   
   procedure Systemtm (Tm : in out asn1SccSystemtelemetry; Dest_PID : asn1sccPID := asn1sccEnv);
   ...
   procedure Get_Sender (Sender : out asn1sccPID; Dest_PID : asn1SccPID := asn1sccEnv)
      with Import, Convention => C, Link_Name => "modemanager_get_sender";
