...
subtype asn1SccPID_Range is adaasn1rtl.Asn1UInt range 0 .. 6;


function asn1SccPID_Range_Equal(val1, val2 : asn1SccPID_Range) return Boolean;

ERR_PID_RANGE:constant Integer := 171; -- (0..6)
...
type asn1SccPID is (asn1Sccactuator, asn1Sccactuator1, asn1Sccactuator2, asn1Sccegse, asn1Sccmodemanager, asn1Sccsensor, asn1Sccenv) with Size => adaasn1rtl.Enumerated_Size;
for asn1SccPID use
    (asn1Sccactuator => 0, asn1Sccactuator1 => 1, asn1Sccactuator2 => 2, asn1Sccegse => 3, asn1Sccmodemanager => 4, asn1Sccsensor => 5, asn1Sccenv => 6);

function asn1SccPID_Equal(val1, val2 : asn1SccPID) return Boolean;

ERR_PID:constant Integer := 176; -- actuator | actuator1 | actuator2 | egse | modemanager | sensor | env
