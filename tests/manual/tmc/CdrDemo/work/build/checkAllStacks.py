...
def report_node_linux():
   ...
   def report_partition_demo():
       ...
       functions[:] = []
       add_task("actuator1_actuatortc")
       add_task("actuator2_actuatortc")
       add_task("egse_poll")
       add_task("egse_systemtm")
       add_task("modemanager_actuatortm1")
       add_task("modemanager_actuatortm2")
       add_task("modemanager_reading")
       add_task("modemanager_systemtc")
       add_task("sensor_trigger")
       ...
       pohic_stack_of = {
           ...
           "actuator1_actuatortc" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "actuator2_actuatortc" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "egse_poll" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "egse_systemtm" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "modemanager_actuatortm1" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "modemanager_actuatortm2" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "modemanager_reading" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "modemanager_systemtc" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "sensor_trigger" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
       ...
       check_task("actuator1_actuatortc", version)
       check_task("actuator2_actuatortc", version)
       check_task("egse_poll", version)
       check_task("egse_systemtm", version)
       check_task("modemanager_actuatortm1", version)
       check_task("modemanager_actuatortm2", version)
       check_task("modemanager_reading", version)
       check_task("modemanager_systemtc", version)
       check_task("sensor_trigger", version)
