...
private
   ...
   procedure Actuator1_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "actuator1_check_queue";
   procedure Actuator2_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "actuator2_check_queue";
   procedure Modemanager_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "modemanager_check_queue";
   procedure Sensor_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "sensor_check_queue";
