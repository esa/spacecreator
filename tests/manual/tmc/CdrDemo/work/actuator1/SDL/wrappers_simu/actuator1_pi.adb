...
package body Actuator1_PI is
   ...
   begin
      ...
      Global_State.Actuator1 := Actuator1.Actuator1_Instance.Ctxt;
   end Startup;

   procedure Continuous_Signals (Global_State : in out asn1SccSystem_State) is
   begin
      Actuator1.Actuator1_Instance.Ctxt := Global_State.Actuator1;
      Actuator1.Actuator1_Instance.Execute_Transition (Actuator1.Actuator1_Instance.CS_Only);
      Global_State.Actuator1 := Actuator1.Actuator1_Instance.Ctxt;
