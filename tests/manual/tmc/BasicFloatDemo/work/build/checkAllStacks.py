...
def report_node_linux():
   ...
   def report_partition_demo():
       ...
       add_task("systemcontrol_reading")
       add_task("systemcontrol_reporting")
       add_task("systemcontrol_tc")
       ...
       pohic_stack_of = {
           ...
           "systemcontrol_reading" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "systemcontrol_reporting" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "systemcontrol_tc" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
       ...
       check_task("systemcontrol_reading", version)
       check_task("systemcontrol_reporting", version)
       check_task("systemcontrol_tc", version)
