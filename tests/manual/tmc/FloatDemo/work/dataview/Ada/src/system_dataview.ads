...
ERR_PID_RANGE:constant Integer := 111; -- (0..4)
...
type asn1SccPID is (asn1Sccactuator, asn1Scccontrolsystem, asn1Scchost, asn1Sccsensor, asn1Sccenv) with Size => adaasn1rtl.Enumerated_Size;
for asn1SccPID use
    (asn1Sccactuator => 0, asn1Scccontrolsystem => 1, asn1Scchost => 2, asn1Sccsensor => 3, asn1Sccenv => 4);

function asn1SccPID_Equal(val1, val2 : asn1SccPID) return Boolean;

ERR_PID:constant Integer := 116; -- actuator | controlsystem | host | sensor | env
