...
def report_node_linux():
   ...
   def report_partition_demo():
       ...
       functions[:] = []
       add_task("actuator_controlsignal")
       add_task("controlsystem_configuration")
       add_task("controlsystem_reading")
       add_task("demo_timer_manager_tick")
       add_task("host_tm")
       add_task("sensor_tc")
       ...
       pohic_stack_of = {
           ...
           "actuator_controlsignal" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "controlsystem_configuration" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "controlsystem_reading" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "demo_timer_manager_tick" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "host_tm" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "sensor_tc" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
       ...
       check_task("actuator_controlsignal", version)
       check_task("controlsystem_configuration", version)
       check_task("controlsystem_reading", version)
       check_task("demo_timer_manager_tick", version)
       check_task("host_tm", version)
       check_task("sensor_tc", version)
