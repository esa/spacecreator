...
private
   ...
   procedure Actuator_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "actuator_check_queue";
   procedure Controlsystem_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "controlsystem_check_queue";
   procedure Host_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "host_check_queue";
