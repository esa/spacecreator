...
public:
    ...
    /**
     * Date: 2022.12.09
     * Result: [RD5] lists several tests demonstrating the capability to generate ASN.1/ACN, interfaceview.xml and
    ...
    /**
     * Date: 2022.12.09
     * Result: [RD5] lists several tests demonstrating the capability to generate SEDS models from ASN.1/ACN files,
    ...
    /**
     * As per chapter 4.1 of [RD2], STBSW GUI is exposed via SedsPlugin component, integrated with SpaceCreatorPlugin
    ...
    /**
     * As per chapter 4.1 of [RD2], STBSW is completely integrated with the QtCreator-based SpaceCreator software, which
