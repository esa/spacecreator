...
set_param('Iface/input','BusObject','MySeqComplex');
add_block('simulink/Commonly Used Blocks/Bus Selector','Iface/input_MySeqComplex_BusSel');
add_line('Iface','input/1','input_MySeqComplex_BusSel/1');
setOutputsBusSelector(MySeqComplex, 'Iface/input_MySeqComplex_BusSel');
if all_inports_created
   set_param('Iface/input_MySeqComplex_BusSel','Position', bussel_positions(inport_index,:));
else
   set_param('Iface/input_MySeqComplex_BusSel','Position',[95 ((inport_index * 100) - 19) 100 ((inport_index * 100) + 19)]);
end
...
set_param('Iface/output','BusObject','MySeqComplex');
add_block('simulink/Commonly Used Blocks/Bus Creator','Iface/output_MySeqComplex_BusCre');
add_line('Iface','output_MySeqComplex_BusCre/1','output/1');
setInputsBusCreator(MySeqComplex,'Iface/output_MySeqComplex_BusCre');
set_param('Iface/output','UseBusObject','on');
set_param('Iface/output','BusOutputAsStruct','on');
 set_param('Iface/output_MySeqComplex_BusCre','BusObject','MySeqComplex');
if all_outports_created
   set_param('Iface/output_MySeqComplex_BusCre','Position', buscre_positions(outport_index,:));
else
   set_param('Iface/output_MySeqComplex_BusCre','Position',[360 ((outport_index * 100) - 19) 365 ((outport_index * 100) + 19)]);
end
set_param('Iface/output_MySeqComplex_BusCre','UseBusObject','on');
set_param('Iface/output_MySeqComplex_BusCre','NonVirtualBus','on');
