...
#define ERR_MYSEQOF		16  /**/
#define ERR_MYSEQOF_ELM_2		11  /**/
flag asn1SccMySeqOf_IsConstraintValid(const asn1SccMySeqOf* pVal, int* pErrCode);

#define ERR_UPER_ENCODE_MYSEQOF		17  /**/
#define ERR_UPER_ENCODE_MYSEQOF_ELM_2		12  /**/
#define asn1SccMySeqOf_REQUIRED_BYTES_FOR_ENCODING       6 
#define asn1SccMySeqOf_REQUIRED_BITS_FOR_ENCODING        42

flag asn1SccMySeqOf_Encode(const asn1SccMySeqOf* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_MYSEQOF		18  /**/
#define ERR_UPER_DECODE_MYSEQOF_ELM_2		13  /**/
flag asn1SccMySeqOf_Decode(asn1SccMySeqOf* pVal, BitStream* pBitStrm, int* pErrCode);

#define ERR_ACN_ENCODE_MYSEQOF		19  /**/
#define ERR_ACN_ENCODE_MYSEQOF_ELM_2		14  /**/
#define asn1SccMySeqOf_REQUIRED_BYTES_FOR_ACN_ENCODING       6 
#define asn1SccMySeqOf_REQUIRED_BITS_FOR_ACN_ENCODING        42

flag asn1SccMySeqOf_ACN_Encode(const asn1SccMySeqOf* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_ACN_DECODE_MYSEQOF		20  /**/
#define ERR_ACN_DECODE_MYSEQOF_ELM_2		15  /**/
...
#define ERR_T_INT32		21  /**/
flag asn1SccT_Int32_IsConstraintValid(const asn1SccT_Int32* pVal, int* pErrCode);

#define ERR_UPER_ENCODE_T_INT32		22  /**/
#define asn1SccT_Int32_REQUIRED_BYTES_FOR_ENCODING       4 
#define asn1SccT_Int32_REQUIRED_BITS_FOR_ENCODING        32

flag asn1SccT_Int32_Encode(const asn1SccT_Int32* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_T_INT32		23  /**/
flag asn1SccT_Int32_Decode(asn1SccT_Int32* pVal, BitStream* pBitStrm, int* pErrCode);

#define ERR_ACN_ENCODE_T_INT32		24  /**/
...
#define ERR_ACN_DECODE_T_INT32		25  /**/
...
#define ERR_T_UINT32		26  /**/
flag asn1SccT_UInt32_IsConstraintValid(const asn1SccT_UInt32* pVal, int* pErrCode);

#define ERR_UPER_ENCODE_T_UINT32		27  /**/
#define asn1SccT_UInt32_REQUIRED_BYTES_FOR_ENCODING       4 
#define asn1SccT_UInt32_REQUIRED_BITS_FOR_ENCODING        32

flag asn1SccT_UInt32_Encode(const asn1SccT_UInt32* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_T_UINT32		28  /**/
flag asn1SccT_UInt32_Decode(asn1SccT_UInt32* pVal, BitStream* pBitStrm, int* pErrCode);

#define ERR_ACN_ENCODE_T_UINT32		29  /**/
...
#define ERR_ACN_DECODE_T_UINT32		30  /**/
...
#define ERR_T_INT8		31  /**/
flag asn1SccT_Int8_IsConstraintValid(const asn1SccT_Int8* pVal, int* pErrCode);

#define ERR_UPER_ENCODE_T_INT8		32  /**/
#define asn1SccT_Int8_REQUIRED_BYTES_FOR_ENCODING       1 
#define asn1SccT_Int8_REQUIRED_BITS_FOR_ENCODING        8

flag asn1SccT_Int8_Encode(const asn1SccT_Int8* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_T_INT8		33  /**/
flag asn1SccT_Int8_Decode(asn1SccT_Int8* pVal, BitStream* pBitStrm, int* pErrCode);

#define ERR_ACN_ENCODE_T_INT8		34  /**/
...
#define ERR_ACN_DECODE_T_INT8		35  /**/
...
#define ERR_T_BOOLEAN		41  /**/
flag asn1SccT_Boolean_IsConstraintValid(const asn1SccT_Boolean* pVal, int* pErrCode);

#define ERR_UPER_ENCODE_T_BOOLEAN		42  /**/
#define asn1SccT_Boolean_REQUIRED_BYTES_FOR_ENCODING       1 
#define asn1SccT_Boolean_REQUIRED_BITS_FOR_ENCODING        1

flag asn1SccT_Boolean_Encode(const asn1SccT_Boolean* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_T_BOOLEAN		43  /**/
flag asn1SccT_Boolean_Decode(asn1SccT_Boolean* pVal, BitStream* pBitStrm, int* pErrCode);

#define ERR_ACN_ENCODE_T_BOOLEAN		44  /**/
...
#define ERR_ACN_DECODE_T_BOOLEAN		45  /**/
