...
cp resources/test_descriptions.system_structure output/system_structure.pr
cp $TEST_OUTPUT_DIR/DESCRIPTIONS.asn $TEST_OUTPUT_DIR/dataview-uniq.asn
# Rename the module to avoid naming conflicts
sed -i 's/DESCRIPTIONS/SYSTEM-DATAVIEW/g' $TEST_OUTPUT_DIR/dataview-uniq.asn
cd $TEST_OUTPUT_DIR
