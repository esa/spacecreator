...
DIFF="diff -w -B"
TEST_OUTPUT_DIR=output_test_indexing
...
# Translate
$SEDS_CONVERTER --from SEDS --to SDL --aux-models ASN.1,InterfaceView --skip-validation -i resources/test_indexing.xml \
...
$DIFF component.pr ../resources/test_indexing.output \
