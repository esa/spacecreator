...
DIFF="diff -w -B"
XMLDIFF="xmldiff"
TEST_OUTPUT_DIR=output_test_interface_inheritance
...
# Translate
$SEDS_CONVERTER --from SEDS --to InterfaceView --aux-models ASN.1 --skip-validation -i resources/test_interface_inheritance.xml \
...
$XMLDIFF interfaceview.xml ../resources/test_interface_inheritance.output \
  && $UPDATE_DATAVIEW \
