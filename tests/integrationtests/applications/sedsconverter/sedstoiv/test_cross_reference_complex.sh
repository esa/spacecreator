...
# Merge ASN files
sed -e '$s/$/\n/' -s package1.asn package2.asn package3.asn package4.asn > dataview-uniq.asn
sed -e '$s/$/\n/' -s package1.acn package2.acn package3.acn package4.acn > dataview-uniq.acn
...
$DIFF interfaceview.xml ../resources/test_cross_reference_complex.output \
