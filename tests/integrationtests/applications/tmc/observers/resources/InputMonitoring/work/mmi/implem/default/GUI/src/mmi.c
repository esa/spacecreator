 ...
 * Generated by TASTE/Kazoo on 2022-04-25 12:04:25
...
void mmi_PI_Poll(void)
{
   ...
   while (!retrieve_message_from_queue(mmi_RI_queue_id,
      ...
      switch(message_received_type) {
         case i_trigger:
            mmi_RI_trigger((asn1SccT_Int32 *)msgcontent);
            break;
       default : break;
      }
   }
