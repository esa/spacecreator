...
package UART_PROTOCOL_DLC_DATAVIEW with SPARK_Mode
is
...
ERR_MYINTEGER:constant Integer := 336; -- (0 .. 10000)
...
private
   --# hide UART_PROTOCOL_DLC_DATAVIEW;


end UART_PROTOCOL_DLC_DATAVIEW;