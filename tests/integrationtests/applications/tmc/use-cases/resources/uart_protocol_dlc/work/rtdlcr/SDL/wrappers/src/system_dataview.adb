...
begin
    ret.Success := (((((((((((((val = asn1Sccbcapp)) OR ((val = asn1Sccbcdlct)))) OR ((val = asn1Sccchanneleffects)))) OR ((val = asn1Sccerroredchannel)))) OR ((val = asn1Sccrtapp)))) OR ((val = asn1Sccrtdlcr)))) OR ((val = asn1Sccenv)));
