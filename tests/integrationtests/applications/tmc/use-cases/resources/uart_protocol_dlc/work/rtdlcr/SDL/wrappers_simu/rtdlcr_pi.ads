...
package Rtdlcr_PI is
   ...
   --  Provided interfaces
   procedure Dlcrxreset (Global_State : in out asn1SccSystem_State);
   
   
   procedure Frametimer (Global_State : in out asn1SccSystem_State);
   ...
   procedure Phyrxerror (Global_State : in out asn1SccSystem_State);
