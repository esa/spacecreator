...
type asn1SccPID is (asn1Sccbcapp, asn1Sccbcdlct, asn1Sccchanneleffects, asn1Sccerroredchannel, asn1Sccrtapp, asn1Sccrtdlcr, asn1Sccenv) with Size => adaasn1rtl.Enumerated_Size;
for asn1SccPID use
    (asn1Sccbcapp => 0, asn1Sccbcdlct => 1, asn1Sccchanneleffects => 2, asn1Sccerroredchannel => 3, asn1Sccrtapp => 4, asn1Sccrtdlcr => 5, asn1Sccenv => 6);

function asn1SccPID_Equal(val1, val2 : asn1SccPID) return Boolean;

ERR_PID:constant Integer := 341; -- bcapp | bcdlct | channeleffects | erroredchannel | rtapp | rtdlcr | env
