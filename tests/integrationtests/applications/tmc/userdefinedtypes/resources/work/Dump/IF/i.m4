...
if_MyBetterInteger_type if_cast_Pinger_integerinterface_integerArg_to_MyBetterInteger_function(if_Pinger_integerinterface_integerArg_type p) {
    if_MyBetterInteger_type r;
    memcpy(&r, &p, sizeof(p));
    return r;
}
