...
private
   ...
   procedure Pinger_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "pinger_check_queue";
   procedure Ponger_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "ponger_check_queue";
