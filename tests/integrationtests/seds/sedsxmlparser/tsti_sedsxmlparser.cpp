...
void
tsti_SedsXmlParser::testComponentsParsing()
{
    try {
...
void
tsti_SedsXmlParser::testContainerDataTypesParsing()
{
    try {
...
void
tsti_SedsXmlParser::testDeviceParsing()
{
    try {
...
void
tsti_SedsXmlParser::testInterfacesParsing()
{
    try {
...
void
tsti_SedsXmlParser::testSimpleDataTypesParsing()
{
    try {
