...
/*!
   Checks is the \p testitem is totally vertically above \p referenceItem
 */
bool isAbove(const QGraphicsItem *testItem, const QGraphicsItem *referenceItem);

/*!
   Checks is the \p testitem is totally vertically below \p referenceItem
 */
bool isBelow(const QGraphicsItem *testItem, const QGraphicsItem *referenceItem);

/*!
   Checks is the \p testitem is totally vertically inside \p referenceItem
 */
