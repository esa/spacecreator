...
#    endif()
  ...
  if (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${name}.json.in")
    ...
    string(REPLACE "\\'" "'" plugin_json_in ${plugin_json_in})
    string(REPLACE "$$PLUGIN_VERSION" "\${CMAKE_PROJECT_VERSION}" plugin_json_in ${plugin_json_in})
    string(REPLACE "$$ORGANISATION_DOMAIN" "\${ORGANISATION_DOMAIN}" plugin_json_in ${plugin_json_in})
    string(REPLACE "$$ORGANISATION" "\${ORGANISATION}" plugin_json_in ${plugin_json_in})
