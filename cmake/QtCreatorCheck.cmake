...
if(QTC_INSTALL)
    message("Found QTC_INSTALL: " ${QTC_INSTALL})
else()
    message(FATAL_ERROR "QTC_INSTALL was NOT set.")
endif()

if(NOT QTC_SOURCE)
    message("QTC_SOURCE was not set. Looking for environment variable")
    set(QTC_SOURCE $ENV{QTC_SOURCE})
endif()
if(QTC_SOURCE)
	message("Found QTC_SOURCE: " ${QTC_SOURCE})
else()
    message(FATAL_ERROR "QTC_SOURCE was NOT set.")
endif()
