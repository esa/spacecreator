...
if (EXISTS ${QTC_SOURCE_DIR} AND EXISTS ${QTC_LIB_DIR})
    ...
    if (EXISTS ${QTC_SOURCE_DIR}/qtcreator.pri)
        file(READ ${QTC_SOURCE_DIR}/qtcreator.pri FILE_CONTENT)
    ...
    if (EXISTS ${QTC_SOURCE_DIR}/src/app/app_version.h)
        file(READ ${QTC_SOURCE_DIR}/src/app/app_version.h FILE_CONTENT)
