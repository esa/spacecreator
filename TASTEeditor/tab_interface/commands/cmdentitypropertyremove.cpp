...
static inline QVariantHash getCurrentProperties(AADLObject *entity, const QStringList &props)
{
    QVariantHash result;
...
CmdEntityPropertyRemove::CmdEntityPropertyRemove(AADLObject *entity, const QStringList &props)
    : QUndoCommand()
    , m_entity(entity)
    , m_names(props)
