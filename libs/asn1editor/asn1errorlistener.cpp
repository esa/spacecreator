...
void Asn1ErrorListener::syntaxError(antlr4::Recognizer *recognizer, antlr4::Token *offendingSymbol, size_t line,
...
QStringList Asn1ErrorListener::getErrorMessages() const
{
