...
class DateMetadataValue final : public MetadataValue
{
public:
    DateMetadataValue() = default;
    DateMetadataValue(DateMetadataValue &&) = default;
    DateMetadataValue &operator=(DateMetadataValue &&) = default;
