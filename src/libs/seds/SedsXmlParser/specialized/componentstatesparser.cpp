...
void ComponentStatesParser::readStateMachineSet(
...
model::StateMachine ComponentStatesParser::readStateMachine(QXmlStreamReader &xmlReader)
{
...
model::EntryState ComponentStatesParser::readEntryState(QXmlStreamReader &xmlReader)
{
...
model::ExitState ComponentStatesParser::readExitState(QXmlStreamReader &xmlReader)
{
...
model::State ComponentStatesParser::readState(QXmlStreamReader &xmlReader)
{
    model::State state;
...
model::Transition ComponentStatesParser::readTransition(QXmlStreamReader &xmlReader)
{
...
bool ComponentStatesParser::processForStateMachineElement(
        model::StateMachineElement *object, const QXmlStreamAttribute &attribute)
{
    return CoreParser::processForNamedEntity(object, attribute);
}

bool ComponentStatesParser::processForStateMachineElement(
        model::StateMachineElement *object, QXmlStreamReader &xmlReader)
{
