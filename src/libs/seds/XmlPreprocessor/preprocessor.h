...
public:
     ...
     */
    static auto preprocess(const QString &inputFilename, const QString &outputFilename,
...
private:
     ...
     * @param   filename            File that is being preprocessed
     */
    static auto parseElementNode(
            QDomElement &element, const ExternalReferencesMap &externalReferences, const QString &filename) -> void;
    /**
