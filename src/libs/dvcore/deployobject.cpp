...
struct DeployObjectPrivate {
    DeployObjectPrivate(const shared::Id &id, const DeployObject::Type t)
    ...
    DeployObjectsModel *m_model;
    const DeployObject::Type m_type;
};

DeployObject::DeployObject(const DeployObject::Type t, const QString &title, QObject *parent, const shared::Id &id)
    : QObject(parent)
    , d(new DeployObjectPrivate(id, t))
{
    connect(this, qOverload<const QString &>(&DeployObject::propertyChanged), this,
            [this](const QString &token) { Q_EMIT propertyChanged(meta::Props::token(token)); });

    connect(this, qOverload<const QString &>(&DeployObject::attributeChanged), this,
...
QString DeployObject::title() const
{
    return attr(meta::Props::token(meta::Props::Token::name)).toString();
}

shared::Id DeployObject::id() const
{
    return d->m_id;
}

DeployObject::Type DeployObject::deployType() const
{
    return d->m_type;
}

bool DeployObject::setTitle(const QString &title)
{
...
bool DeployObject::setParentObject(DeployObject *parentObject)
{
...
QVector<qint32> DeployObject::coordinatesFromString(const QString &strCoordinates)
{
...
QString DeployObject::coordinatesToString(const QVector<qint32> &coordinates)
{
    QString coordString;
...
QVector<qint32> DeployObject::coordinates() const
{
...
void DeployObject::setCoordinates(const QVector<qint32> &coordinates)
{
...
DeployObject *DeployObject::parentObject() const
{
    return qobject_cast<DeployObject *>(parent());
}

QHash<QString, QVariant> DeployObject::attrs() const
{
    return d->m_attrs;
}

void DeployObject::setAttrs(const QHash<QString, QVariant> &attrs)
{
    if (d->m_attrs != attrs) {
        d->m_attrs.clear();
...
QVariant DeployObject::attr(const QString &name, const QVariant &defaultValue) const
{
    return d->m_attrs.value(name, defaultValue);
}

void DeployObject::setAttr(const QString &name, const QVariant &val)
{
    d->m_attrs[name] = val;
    Q_EMIT attributeChanged(name);
}

void DeployObject::removeAttr(const QString &name)
{
 ...
 */
bool DeployObject::hasAttribute(const QString &attributeName, const QVariant &value) const
{
 ...
 */
bool DeployObject::hasAttributes(const QHash<QString, QVariant> &attrs) const
{
...
QHash<QString, QVariant> DeployObject::props() const
{
    return d->m_props;
}

void DeployObject::setProps(const QHash<QString, QVariant> &props)
{
    if (props != d->m_props) {
        d->m_props.clear();
...
QVariant DeployObject::prop(const QString &name, const QVariant &defaultValue) const
{
    return d->m_props.value(name, defaultValue);
}

void DeployObject::setProp(const QString &name, const QVariant &val)
{
...
void DeployObject::removeProp(const QString &name)
{
 ...
 */
bool DeployObject::hasProperty(const QString &propertyName, const QVariant &value) const
{
 ...
 */
bool DeployObject::hasProperties(const QHash<QString, QVariant> &props) const
{
...
void DeployObject::setObjectsModel(DeployObjectsModel *model)
{
    d->m_model = model;
}

DeployObjectsModel *DeployObject::objectsModel() const
{
    return d->m_model;
}
