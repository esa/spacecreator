...
public:
    ExportableAttribute(const QString &name = QString(), const QVariant &value = QVariant())
        : m_name(name)
        , m_value(value)
    {
    }
...
Q_DECLARE_METATYPE(shared::ExportableAttribute)
Q_DECLARE_TYPEINFO(shared::ExportableAttribute, Q_MOVABLE_TYPE);
