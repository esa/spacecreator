...
static const qreal COMMENT_BORDER_WIDTH = 1;
static const qreal COMMENT_MARIN = 6 + COMMENT_BORDER_WIDTH;
...
static const qreal MAX_TEXT_WIDTH = 250.0;

static const QRectF TIMER_SYMBOL_SIZE(0, 0, 50, 25);
