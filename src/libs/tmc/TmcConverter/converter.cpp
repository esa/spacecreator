...
{
    // Based on required interfaces of environment functions
    // the envDataTypes is filled with type names for which the values will be generated by environment.
    // Since only input parameters require value generation, the output parameters are ignored here.
    // The model shall set values of output parameters, but the model cannot read them
