...
public:
    ...
    static AlignToNext mapAlignToNext(QStringView in);
    static AlignToNext mapAlignToNext(const QString &in) { return mapAlignToNext(QStringView(in)); }

    static Endianness mapEndianess(QStringView in);
    static Endianness mapEndianess(const QString &in) { return mapEndianess(QStringView(in)); }
