...
public:
    ...
    static QString nameForInstance(const AADLFunction *object, const QString &suggestedName = QString());
...
private:
    ...
    bool isRequiredInterfaceNameUsed(const QString &name, const AADLFunctionType *parent) const;
    bool isProvidedInterfaceNameUsed(const QString &name, const AADLFunctionType *parent) const;
};
