...
/**
 * @brief   Registers conversion capabilities for SIMULINK model
 */
class SimulinkRegistrar final : public Registrar
{
public:
    /**
     * @brief   Register SIMULINK conversion capabilties
     *
