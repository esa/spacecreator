...
{
    if (sedsType.bits() > static_cast<::seds::model::PositiveLong::Value>(std::numeric_limits<Asn1Acn::IntegerValue::Type>::max())) {
...
{
    if (sedsType.length() > static_cast<::seds::model::PositiveLong::Value>(std::numeric_limits<Asn1Acn::IntegerValue::Type>::max())) {
