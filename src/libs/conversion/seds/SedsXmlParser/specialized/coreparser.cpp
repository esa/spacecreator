...
common::String
CoreParser::readLongDescription(QXmlStreamReader& xmlReader)
{
    return xmlReader.readElementText();
}

bool
CoreParser::parseBool(QStringRef valueStr)
{
    return QVariant(valueStr.toString()).toBool();
}

uint8_t
CoreParser::parseUInt8(QStringRef valueStr)
{
    bool ok = false;
...
int32_t
CoreParser::parseInt32(QStringRef valueStr)
{
    bool ok = false;
...
int64_t
CoreParser::parseInt64(QStringRef valueStr)
{
    bool ok = false;
...
uint64_t
CoreParser::parseUInt64(QStringRef valueStr)
{
    bool ok = false;
...
double
CoreParser::parseDouble(QStringRef valueStr)
{
    bool ok = false;
...
model::PositiveLong::Value
CoreParser::parsePositiveLong(QStringRef valueStr)
{
    bool ok = false;
    const auto value = valueStr.toULong(&ok);
...
bool
CoreParser::processForDescription(model::Description* object, const QXmlStreamAttribute& attribute)
{
...
bool
CoreParser::processForDescription(model::Description* object, QXmlStreamReader& xmlReader)
{
...
bool
CoreParser::processForNamedEntity(model::NamedEntity* object, const QXmlStreamAttribute& attribute)
{
...
bool
CoreParser::processForNamedEntity(model::NamedEntity* object, QXmlStreamReader& xmlReader)
{
