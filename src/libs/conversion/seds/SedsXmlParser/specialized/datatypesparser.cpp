...
void
DataTypesParser::readDataTypeSet(DataTypesParser::DataTypeAddingFunction addDataType, QXmlStreamReader& xmlReader)
{
...
bool
DataTypesParser::processForExternalField(model::ExternalField* object, const QXmlStreamAttribute& attribute)
{
...
bool
DataTypesParser::processForExternalField(model::ExternalField* object, QXmlStreamReader& xmlReader)
{
...
bool
DataTypesParser::processForField(model::Field* object, const QXmlStreamAttribute& attribute)
{
...
bool
DataTypesParser::processForField(model::Field* object, QXmlStreamReader& xmlReader)
{
...
model::ArrayDataType
DataTypesParser::readArrayDataType(QXmlStreamReader& xmlReader)
{
...
model::BinaryDataType
DataTypesParser::readBinaryDataType(QXmlStreamReader& xmlReader)
{
...
model::BooleanDataType
DataTypesParser::readBooleanDataType(QXmlStreamReader& xmlReader)
{
...
model::ContainerDataType
DataTypesParser::readContainerDataType(QXmlStreamReader& xmlReader)
{
...
model::EnumeratedDataType
DataTypesParser::readEnumeratedDataType(QXmlStreamReader& xmlReader)
{
...
model::FloatDataType
DataTypesParser::readFloatDataType(QXmlStreamReader& xmlReader)
{
...
model::IntegerDataType
DataTypesParser::readIntegerDataType(QXmlStreamReader& xmlReader)
{
...
DataTypesParser::readStringDataType(QXmlStreamReader& xmlReader)
{
...
model::SubRangeDataType
DataTypesParser::readSubRangeDataType(QXmlStreamReader& xmlReader)
{
...
model::BooleanDataEncoding
DataTypesParser::readBooleanDataEncoding(QXmlStreamReader& xmlReader)
{
...
model::FloatDataEncoding
DataTypesParser::readFloatDataEncoding(QXmlStreamReader& xmlReader)
{
...
model::IntegerDataEncoding
DataTypesParser::readIntegerDataEncoding(QXmlStreamReader& xmlReader)
{
...
model::StringDataEncoding
DataTypesParser::readStringDataEncoding(QXmlStreamReader& xmlReader)
{
...
model::FloatDataType::Range
DataTypesParser::readFloatDataRange(QXmlStreamReader& xmlReader)
{
...
model::IntegerDataType::Range
DataTypesParser::readIntegerDataRange(QXmlStreamReader& xmlReader)
{
    xmlReader.readNextStartElement();
...
model::DerivedTypeRange
DataTypesParser::readDerivedTypeRange(QXmlStreamReader& xmlReader)
{
    xmlReader.readNextStartElement();
...
model::EnumeratedDataTypeRange
DataTypesParser::readEnumeratedDataTypeRange(QXmlStreamReader& xmlReader)
{
...
model::MinMaxRange
DataTypesParser::readMinMaxRange(QXmlStreamReader& xmlReader)
{
...
void
DataTypesParser::readEntryList(DataTypesParser::EntryAddingFunction addEntry, QXmlStreamReader& xmlReader)
{
    for(const auto& attribute : xmlReader.attributes()) {
        throw UnhandledAttribute(attribute.name(), xmlReader.name());
    }
...
model::Entry
DataTypesParser::readEntry(QXmlStreamReader& xmlReader)
{
    model::Entry entry;
...
model::ErrorControlEntry
DataTypesParser::readErrorControlEntry(QXmlStreamReader& xmlReader)
{
...
model::FixedValueEntry
DataTypesParser::readFixedValueEntry(QXmlStreamReader& xmlReader)
{
...
model::LengthEntry
DataTypesParser::readLengthEntry(QXmlStreamReader& xmlReader)
{
...
model::ListEntry
DataTypesParser::readListEntry(QXmlStreamReader& xmlReader)
{
...
model::PaddingEntry
DataTypesParser::readPaddingEntry(QXmlStreamReader& xmlReader)
{
...
void
DataTypesParser::readEnumerationList(model::EnumeratedDataType& dataType, QXmlStreamReader& xmlReader)
{
    for(const auto& attribute : xmlReader.attributes()) {
        throw UnhandledAttribute(attribute.name(), xmlReader.name());
    }
...
model::ValueEnumeration
DataTypesParser::readEnumeration(QXmlStreamReader& xmlReader)
{
...
void
DataTypesParser::readDimensionList(DataTypesParser::DimensionAddingFunction addDimension, QXmlStreamReader& xmlReader)
{
    for(const auto& attribute : xmlReader.attributes()) {
        throw UnhandledAttribute(attribute.name(), xmlReader.name());
    }
...
model::DimensionSize
DataTypesParser::readDimensionSize(QXmlStreamReader& xmlReader)
{
...
void
DataTypesParser::readConstraintSet(model::ContainerDataType& dataType, QXmlStreamReader& xmlReader)
{
    for(const auto& attribute : xmlReader.attributes()) {
        throw UnhandledAttribute(attribute.name(), xmlReader.name());
    }
...
model::ContainerRangeConstraint
DataTypesParser::readRangeConstraint(QXmlStreamReader& xmlReader)
{
...
model::ContainerTypeConstraint
DataTypesParser::readTypeConstraint(QXmlStreamReader& xmlReader)
{
...
model::ContainerValueConstraint
DataTypesParser::readValueConstraint(QXmlStreamReader& xmlReader)
{
...
model::FloatDataEncoding::Encoding
DataTypesParser::parseFloatEncoding(QStringRef encodingStr)
{
...
model::IntegerDataEncoding::Encoding
DataTypesParser::parseIntegerEncoding(QStringRef encodingStr)
{
    auto encodingStdStr = encodingStr.toString().toStdString();
    std::transform(encodingStdStr.begin(), encodingStdStr.end(), encodingStdStr.begin(), ::toupper);
...
model::StringDataEncoding::Encoding
DataTypesParser::parseStringEncoding(QStringRef encodingStr)
{
    auto encodingStdStr = encodingStr.toString().toStdString();
    std::transform(encodingStdStr.begin(), encodingStdStr.end(), encodingStdStr.begin(), ::toupper);
...
model::FloatPrecisionRange
DataTypesParser::parseFloatPrecisionRange(QXmlStreamReader& xmlReader)
{
...
model::ByteOrder
DataTypesParser::parseByteOrder(QStringRef byteOrderStr)
{
...
model::ErrorControlEntry::ErrorControl
DataTypesParser::parseErrorControl(QStringRef errorControlStr)
{
...
model::FalseValue
DataTypesParser::parseFalseValue(QStringRef falseValueStr)
{
...
model::RangeType
DataTypesParser::parseRangeType(QStringRef rangeTypeStr)
{
...
bool
DataTypesParser::processForContainerConstraint(model::ContainerConstraint* object, const QXmlStreamAttribute& attribute)
{
...
bool
DataTypesParser::processForContainerConstraint(model::ContainerConstraint* object, QXmlStreamReader& xmlReader)
{
    return CoreParser::processForDescription(object, xmlReader);
}

bool
DataTypesParser::processForDataEncoding(model::DataEncoding* object, const QXmlStreamAttribute& attribute)
{
...
bool
DataTypesParser::processForDataEncoding(model::DataEncoding* object, QXmlStreamReader& xmlReader)
{
    (void)object;
    (void)xmlReader;
    return false;
...
bool
DataTypesParser::processForEntry(model::Entry* object, const QXmlStreamAttribute& attribute)
{
    return processForExternalField(object, attribute);
}

bool
DataTypesParser::processForEntry(model::Entry* object, QXmlStreamReader& xmlReader)
{
    return processForExternalField(object, xmlReader);
}

bool
DataTypesParser::processForRootDataType(model::RootDataType* object, const QXmlStreamAttribute& attribute)
{
    return CoreParser::processForNamedEntity(object, attribute);
}

bool
DataTypesParser::processForRootDataType(model::RootDataType* object, QXmlStreamReader& xmlReader)
{
