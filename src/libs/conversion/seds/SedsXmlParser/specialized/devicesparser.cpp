...
model::Device
DevicesParser::readDevice(QXmlStreamReader& xmlReader)
{
    model::Device device;
...
model::Metadata
DevicesParser::readMetadata(QXmlStreamReader& xmlReader)
{
...
void
DevicesParser::readMetadataValueSet(DevicesParser::MetadataValueAddingFunction addValue, QXmlStreamReader& xmlReader)
{
    for(const auto& attribute : xmlReader.attributes()) {
        throw UnhandledAttribute(attribute.name(), xmlReader.name());
    }
...
model::DateMetadataValue
DevicesParser::readDateMetadataValue(QXmlStreamReader& xmlReader)
{
...
model::FloatMetadataValue
DevicesParser::readFloatMetadataValue(QXmlStreamReader& xmlReader)
{
...
model::IntegerMetadataValue
DevicesParser::readIntegerMetadataValue(QXmlStreamReader& xmlReader)
{
...
model::StringMetadataValue
DevicesParser::readStringMetadataValue(QXmlStreamReader& xmlReader)
{
...
DevicesParser::readMetadataCategory(QXmlStreamReader& xmlReader)
{
...
bool
DevicesParser::processForMetadataValue(model::MetadataValue* object, const QXmlStreamAttribute& attribute)
{
    return CoreParser::processForNamedEntity(object, attribute);
}

bool
DevicesParser::processForMetadataValue(model::MetadataValue* object, QXmlStreamReader& xmlReader)
{
