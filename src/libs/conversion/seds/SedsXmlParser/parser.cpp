...
Parser::parse(const QString& inputSedsFilename)
{
...
model::PackageFile
Parser::readPackageFile(QXmlStreamReader& xmlReader)
{
...
model::DataSheet
Parser::readDataSheet(QXmlStreamReader& xmlReader)
{
...
model::Package
Parser::readPackage(QXmlStreamReader& xmlReader)
{
