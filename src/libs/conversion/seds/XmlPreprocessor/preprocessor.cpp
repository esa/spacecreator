...
void XmlPreprocessor::preprocess(
        const QString &inputFilename, const QString &outputFilename, const ExternalReferencesMap &externalReferences)
{
...
void XmlPreprocessor::processXInclude(const QString &inputFilename, const QString &outputFilename)
{
...
void XmlPreprocessor::processExternalReferences(
        const QString &filename, const ExternalReferencesMap &externalReferences)
{
...
void XmlPreprocessor::parseNode(
        QDomNode &node, const ExternalReferencesMap &externalReferences, const QString &filename)
{
    if (node.isElement()) {
...
void XmlPreprocessor::parseElementNode(
        QDomElement &element, const ExternalReferencesMap &externalReferences, const QString &filename)
{
...
void XmlPreprocessor::parseTextNode(
        QDomText &text, const ExternalReferencesMap &externalReferences, const QString &filename)
{
