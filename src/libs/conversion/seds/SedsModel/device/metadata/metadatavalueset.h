...
using MetadataValueType =
        std::variant<DateMetadataValue, FloatMetadataValue, IntegerMetadataValue, StringMetadataValue>;
using MetadataValueSet = std::vector<MetadataValueType>;
