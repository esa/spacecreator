...
void
XmlValidator::validate(const QString& inputFilename, const QString& schemaFilename)
{
    ...
    xmlSchemaSetParserErrors(parserCtx,
                             static_cast<xmlSchemaValidityErrorFunc>(XmlValidator::libXmlErrorFunc),
                             static_cast<xmlSchemaValidityWarningFunc>(XmlValidator::libXmlWarningFunc),
                             static_cast<void*>(&errorStr));
...
void
XmlValidator::libXmlErrorFunc(void* context, const char* format, ...)
{
    char buf[1024];
    va_list args;
...
void
XmlValidator::libXmlWarningFunc(void* context, const char* format, ...)
{
    char buf[1024];
    va_list args;
