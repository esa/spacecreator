...
const QString inputFilePath = "\"%1\" file was chosen";
const QString functionBlockName = "\"%1\" function block name was chosen";
const QString workspaceFileWasFound = "\"%1\" workspace file was found";
const QString workspaceFileWasNotFound = "Workspace file was not found";
