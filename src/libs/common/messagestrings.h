...
const QString fileHasBeenOverrided = "%1 file has been overrided";
const QString fileHasNotBeenOverrided = "%1 file has not been overrided";
...
const QString executingMatlabCommand = "Executing MatLab command ... ";
...
const QString ivModelShouldContainOnlyOneIvFunction = "IV model should contain only one IV function";
