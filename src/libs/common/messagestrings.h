...
const QString functionBlockNameWasChosen = "\"%1\" function block name was chosen";
const QString workspaceFileWasFound = "\"%1\" workspace file was found";
const QString workspaceFileIsNotUsed = "Workspace file is not used";
...
const QString executingMatlabCommand = "Executing MatLab command : matlab -batch %1";
