...
AADLConnectionGroupGraphicsItem::AADLConnectionGroupGraphicsItem(ivm::IVConnectionGroup *connection,
...
{
    connect(connection, &ivm::IVObject::titleChanged, this, &AADLConnectionGroupGraphicsItem::updateLabel);
}
...
{
    AADLConnectionGraphicsItem::updateBoundingRect();
    updateTitleItemPosition();
}

void AADLConnectionGroupGraphicsItem::updateLabel(const QString &text)
{
...
void AADLConnectionGroupGraphicsItem::updateTitleItemPosition()
{
