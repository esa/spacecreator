...
bool ModelCheckingWindow::handleBooleanStopConditionLTL(const QString newPropertyDirectoryPath, const QString &propertyName)
{
...
bool ModelCheckingWindow::handleMessageSequenceChartWhenThen(const QString newPropertyDirectoryPath, const QString &propertyName)
{
...
void ModelCheckingWindow::setSpinConfigParams(SpinConfigData spinConfig)
{
    ...
    d->ui->lineEdit_generationLimit->setText(SpinConfigData::optionalIntToString(spinConfig.globalInputVectorGenerationLimit));
...
SpinConfigData ModelCheckingWindow::readSpinConfigFromUI()
{
    ...
    spinConfigData.globalInputVectorGenerationLimit = SpinConfigData::optionalIntFromString(d->ui->lineEdit_generationLimit->text());
