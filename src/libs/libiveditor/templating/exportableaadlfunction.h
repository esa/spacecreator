...
/**
 * @brief The ExportableAADLFunction is a class to export AADLFunctionType and AADLFunction
 */
...
public:
    explicit ExportableAADLFunction(const ivm::AADLFunctionType *function = nullptr);
