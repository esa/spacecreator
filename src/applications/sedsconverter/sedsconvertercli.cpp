...
void SedsConverterCLI::parseArguments(const QStringList &arguments)
{
    ...
    m_parser.handlePositional(CommandArg::SedsConverterFunctionToConvert);
    m_parser.handlePositional(CommandArg::SedsConverterFlatPackage);
...
void SedsConverterCLI::addAsn1OutputOptions(Options &options)
{
    ...
    if (m_arguments.contains(CommandArg::SedsConverterMappingFunctionsModuleFileName)) {
        options.add(Asn1Options::mappingFunctionsModuleFileName,
                m_parser.value(CommandArg::SedsConverterMappingFunctionsModuleFileName));
    }
}
...
void SedsConverterCLI::addSedsTranslationOptions(Options &options)
{
    ...
    if (m_arguments.contains(CommandArg::SedsConverterFunctionToConvert)) {
        options.add(IvOptions::functionToConvert, m_parser.value(CommandArg::SedsConverterFunctionToConvert));
    }
