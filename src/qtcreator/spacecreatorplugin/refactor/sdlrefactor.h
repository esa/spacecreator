...
/*!
 * The SdlRefactor class performs the refactoring for SDL implemenation files. Using simple "search and replace"
 */
class SdlRefactor : public ReplaceRefactorBase
{
public:
